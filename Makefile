...
mainshell: builtin_cd.o builtin_dir.o builtin_exit.o builtin_getenv.o builtin_gid.o builtin_help.o builtin_history.o builtin_lookup.o builtin_pid.o builtin_setenv.o builtin_status.o builtin_uid.o builtin_unsetenv.o ejecutar.o externo.o linea2argv.o
